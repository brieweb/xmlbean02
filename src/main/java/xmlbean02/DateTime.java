...
public class DateTime {
   ...
   public static void main(String args[]){
       ...
       dt.createDocument(doc,"zed_output.xml");
           ...
           if (i==0){
               ...
               for (int j=0;j<holiday.length;j++){
                   if (j==0){
                       ...
                       System.out.println("Format:" + df.format(holiday[i].getDateValue()));
               ...
               System.out.println("Format:" + df.format(impdate[i].xgetBirthdatetime().getDateValue()));
   ...
   public void createDocument(DatetimeDocument doc , String file){
       ...
       Calendar  birthdatetime = new XmlCalendar("1977-11-29T10:10:12-08:00");
